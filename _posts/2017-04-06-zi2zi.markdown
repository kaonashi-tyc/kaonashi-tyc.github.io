...
* Model is limited to output only one target font style at a time

That is how zi2zi comes into being, an attempt to solve the above problems in one blow, this time blessed with the mighty power of [GAN](https://arxiv.org/abs/1406.2661). Personally, it also serves as a playground for me to tap into the wonderland of GAN and its variants.
